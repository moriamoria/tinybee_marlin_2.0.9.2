...
#define AXIS_STEPS_MULTIPLIER 4
/**
 * Configuration.h
 *
...
#define STRING_CONFIG_H_AUTHOR "(2024/12/13, ortur.bigtree)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME  TOSTRING(__DATE__) " " TOSTRING(__TIME__)
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 450, 450, 50, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -24, -15, -0.43 }
